...
package org.woodbridgehigh.healthid.zxing;
...
public abstract class ContactEncoder {
   ...
   */
  public abstract String[] encode(List<String> names,
                                  String organization,
  ...
  static void appendUpToUnique(StringBuilder newContents,
    ...
    for (int i = 0; i < values.size(); i++) {
      ...
      if (trimmed != null && !trimmed.isEmpty() && !uniques.contains(trimmed)) {
        ...
        CharSequence display = displayFormatter == null ? trimmed : displayFormatter.format(trimmed, i).toString();
