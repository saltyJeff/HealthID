...
public class Activity_BluetoothPrinterList extends ListActivity {
    ...
    public static final String IP_EXTRA= "ipAddress";
    public static final String MAC_ADDRESS_EXTRA = "MAC_ADDRESS_EXTRA";
    public static final String PRINTER_EXTRA = "PRINTER";
    /**
     * initialize activity
     */
    @Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        getPairedPrinters();
        this.setTitle("Bluetooth printer list");
    }
    ...
    protected void onListItemClick(ListView listView, View view, int position,
        ...
        if (!item.equalsIgnoreCase(getString(R.string.no_bluetooth_device))) {
            ...
            final Intent settings = new Intent(this, PrintActivity.class);
            settings.putExtra(IP_EXTRA,
                    mBluetoothPrinter[position].ipAddress);
            settings.putExtra(MAC_ADDRESS_EXTRA,
                    mBluetoothPrinter[position].macAddress);
            settings.putExtra(PRINTER_EXTRA, mBluetoothPrinter[position].modelName);
